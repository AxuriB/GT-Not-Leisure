    ...
    public void loadRecipes() {
        ...
        if (MainConfig.enableDeleteRecipe) {
            ...
            ItemStack[] CHIP = { GTOreDictUnificator.get(OrePrefixes.spring, Materials.Tin, 1),
                ...
                ItemList.Circuit_Chip_HPIC.get(1), ItemList.Circuit_Chip_UHPIC.get(1),
                ItemList.Circuit_Chip_QPIC.get(1), ItemList.Circuit_Chip_NPIC.get(1), ItemList.Circuit_Chip_PPIC.get(1),
                ItemList.Circuit_Chip_PPIC.get(2), ItemList.Circuit_Chip_PPIC.get(4), ItemList.Circuit_Chip_PPIC.get(8),
                ItemList.Circuit_Chip_PPIC.get(16), ItemList.Circuit_Chip_PPIC.get(32) };
