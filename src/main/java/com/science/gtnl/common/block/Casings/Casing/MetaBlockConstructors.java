...
public final class MetaBlockConstructors {
    ...
    public static ItemStack initMetaBlock(String originEnglishName, int meta, MetaCasingBase basicBlock) {
    ...
    public static ItemStack initMetaBlockCasing(String originEnglishName, int meta, MetaBlockCasingBase basicBlock) {
